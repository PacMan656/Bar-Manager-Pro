...
public class ImpostoDAO {
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO erp_beer.IMPOSTOS (IRPJ, CSLL, PIS, COFINS, IPI, ICMS, ISS, CPP, MES, FLUXOMES, \"DATA\")" +
"	VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    public List<Imposto> readImpostos(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.IMPOSTOS ORDER BY \"DATA\" desc");
