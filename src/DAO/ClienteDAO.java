...
public class ClienteDAO {
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO erp_beer.bancocliente (nome,nascimento,rua,bairro,numero,cpf,rg,telefone1,telefone2,nota) VaLUES(?,?,?,?,?,?,?,?,?,?)");
    ...
    public List<Cliente> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.bancocliente");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.bancocliente SET nome = ?,nascimento = ?, rua = ?, bairro = ?, numero = ?, cpf = ?, rg = ?, telefone1 = ?, telefone2 = ? WHERE cpf = ? or rg = ?");
            stmt.setString(1,c.getNome());
            stmt.setString(2,c.getNascimento());
            stmt.setString(3,c.getRua());
            stmt.setString(4,c.getBairro());
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.bancocliente SET nota = nota + ? WHERE cpf = ? or rg = ?");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("DELETE FROM erp_beer.bancocliente WHERE cpf = ? OR rg = ? OR nome = ?");
