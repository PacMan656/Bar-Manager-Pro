...
public class ServicosDAO {
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO erp_beer.servicos (Descrição , Data, Empresa, Telefone, "
    ...
    public List<Servicos> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.servicos");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.servicos SET Data = ?, Telefone = ?, Endereço = ?,"
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("DELETE FROM erp_beer.servicos WHERE id = ?");
            stmt.setInt(1, id);
