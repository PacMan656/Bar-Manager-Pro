...
public class NotasNFCeDAO {
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO erp_beer.nfces (\"Numero\",\"Serie\",\"Forma\",\"Loja\",\"Caixa\",\"Valor\")"
                    + " VALUES(?,?,?,?,?,?)");
     ...
     public List<NotaNFCe> LerNotas(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.nfces ORDER BY \"Numero\"");
     ...
     Connection con = ConnectorMySQL.getConnection();
        ...
        ResultSet rs = null;
        try {
            stmt = con.prepareStatement("Select Max(\"Numero\") FROM erp_beer.NFCES where \"Loja\" = ? and \"Caixa\" = ? and \"Serie\" = ?");
     ...
     Connection con = ConnectorMySQL.getConnection();
        ...
        ResultSet rs = null;
        try {
            stmt = con.prepareStatement("Select Max(\"Serie\") FROM erp_beer.NFCES where \"Loja\" = ?, \"Caixa\" = ?");
            stmt.setString(1,loja);
            stmt.setString(2,caixa);
            rs = stmt.executeQuery();
      ...
      public int Id(){
        ...
        try {
            stmt = con.prepareStatement("Select Max(\"Id\") FROM erp_beer.NFCES");
            rs = stmt.executeQuery();
