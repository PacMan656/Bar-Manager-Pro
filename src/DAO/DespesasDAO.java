...
public class DespesasDAO {
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO erp_beer.despesas (Descrição , Data, Empresa, Telefone, "
    ...
    public List<Despesas> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.despesas");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.despesas SET Data = ?, Telefone = ?, Endereço = ?,"
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("DELETE FROM erp_beer.despesas WHERE id = ?");
            stmt.setInt(1, id);
