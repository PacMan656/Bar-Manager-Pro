...
public class ProdutoDAO {
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO erp_beer.produtos (codigo,descrição,quantidade,tipo,preçoun,"
    ...
    public List<Produto> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.produtos SET descrição = ? ,"
                                                                         + "preçoUn = ?, "
                                                                         + "Unidade = ?, "
                                                                         + "Dataentrada = ?, "
                                                                         + "quantidade = ?,"
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("DELETE FROM erp_beer.produtos WHERE codigo = ?");
            stmt.setString(1,p.getCodigo());
    ...
    public List<Produto> readdesc(String desc){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE codigo LIKE ?");
    ...
    public List<Produto> readdescordem(String desc){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE codigo LIKE ? order by quantidade");
            stmt.setString(1, ""+desc+"");
            rs = stmt.executeQuery();
    ...
    Connection con = ConnectorMySQL.getConnection();
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE tipo LIKE ?");
    ...
    Connection con = ConnectorMySQL.getConnection();
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE quantidade <= 10");
    ...
    public List<Produto> readQTipo(String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE quantidade <= 10 AND tipo LIKE ?");
            stmt.setString(1, ""+tipo+"");
            rs = stmt.executeQuery();
    ...
    public List<Produto> Procurar(String descrição){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE descrição LIKE ?");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.produtos SET quantidade = quantidade - ? WHERE codigo = ?");
    ...
    public List<Produto> procurarLoja(String loja){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE Loja LIKE ? order by quantidade");
    ...
    public List<Produto> procurarLojaEQuantidade(String loja, int Quantidade){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE Loja LIKE ? AND quantidade <= ? order by quantidade");
            stmt.setString(1, ""+loja+"");
    ...
    public List<Produto> procurarLojaEQuantidadeETipo(String loja, int Quantidade, String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE Loja LIKE ? AND quantidade <= ? AND tipo LIKE ? order by quantidade");
            stmt.setString(1, loja);
            stmt.setInt(2, Quantidade);
    ...
    public List<Produto> procurarQuantidadeETipo(int Quantidade, String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE quantidade <= ? AND tipo LIKE ? order by quantidade");
    ...
    public List<Produto> procurarQuantidade(int Quantidade){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE quantidade <= ? order by quantidade");
            stmt.setInt(1, Quantidade);
            rs = stmt.executeQuery();
    ...
    public List<Produto> procurarLojaETipo(String loja, String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE Loja LIKE ? AND tipo LIKE ? order by quantidade");
            stmt.setString(1, loja);
            stmt.setString(2, tipo);
            rs = stmt.executeQuery();
    ...
    public List<Produto> procurarTipo(String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.produtos WHERE tipo LIKE ? order by quantidade");
            stmt.setString(1, tipo);
            rs = stmt.executeQuery();
    ...
    public int idsem(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.PRODUTOS order by codigo");
            rs = stmt.executeQuery();
