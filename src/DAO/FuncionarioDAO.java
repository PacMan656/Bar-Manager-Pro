...
public class FuncionarioDAO {
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO erp_beer.bancofuncionario (nome,email,nascimento,cpf,rg,telefone1,telefone2,cargo,cargahoraria,formação,atributos,salario) VaLUES(?,?,?,?,?,?,?,?,?,?,?,?)");
