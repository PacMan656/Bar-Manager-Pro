...
public class BalançaDAO {
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO erp_beer.balancas"
    ...
    public List<Balança> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.balancas");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.balancas SET comunicacao = ?,porta = ?,fabricante = ?,modelo = ?,"
                    + "local = ? WHERE id = ?");
            stmt.setString(1, b.getComunicação());
            stmt.setString(2,b.getPorta());
            stmt.setString(3,b.getFabricante());
    ...
    public int idsem(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.balancas ORDER BY id");
            rs = stmt.executeQuery();
