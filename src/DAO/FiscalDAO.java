...
public class FiscalDAO {
    ...
    public List<Fiscal> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.fiscal");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.fiscal SET cnpj = ?, razaosocial = ?, rua = ?,bairro = ?,"
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.fiscal SET cvalidade = ? WHERE id = 1");
