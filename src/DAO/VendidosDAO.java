...
public class VendidosDAO {
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO erp_beer.vendasprodutos "
    ...
    public List<Vendidos> read(){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.vendasprodutos");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("UPDATE erp_beer.vendasprodutos SET quantidade = quantidade + ?  WHERE código = ?");
    ...
    public List<Vendidos> PorArea(String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.vendasprodutos WHERE Tipo LIKE ? ORDER BY Quantidade");
    ...
    public List<Vendidos> PorLoja(String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.vendasprodutos WHERE Loja LIKE ? ORDER BY Quantidade");
            stmt.setString(1, ""+tipo+"");
            rs = stmt.executeQuery();
    ...
    public List<Vendidos> PorCaixa(String loja, String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.vendasprodutos WHERE Loja LIKE ? AND Caixa LIKE ? ORDER BY Quantidade");
    ...
    public List<Vendidos> PorAreaMenos(String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.vendasprodutos WHERE Tipo LIKE ? ORDER BY Quantidade DESC");
            stmt.setString(1, ""+tipo+"");
            rs = stmt.executeQuery();
    ...
    public List<Vendidos> PorLojaMenos(String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.vendasprodutos WHERE Loja LIKE ? ORDER BY Quantidade DESC");
            stmt.setString(1, ""+tipo+"");
            rs = stmt.executeQuery();
    ...
    public List<Vendidos> PorCaixaMenos(String loja, String tipo){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.vendasprodutos WHERE Loja LIKE ? AND Caixa LIKE ? ORDER BY Quantidade DESC");
            stmt.setString(1, ""+loja+"");
            stmt.setString(2, ""+tipo+"");
            rs = stmt.executeQuery();
    ...
    public List<Vendidos> PorIdVenda(int IdVenda, String caixa, String Loja){
        ...
        try {
            stmt = con.prepareStatement("SELECT * FROM erp_beer.vendasprodutos WHERE IdVenda = ? AND Caixa LIKE ? AND Loja LIKE ? ORDER BY Datasaida");
    ...
    PreparedStatement stmt = null;
        ...
        try {
            stmt = con.prepareStatement("DELETE FROM erp_beer.vendasprodutos WHERE código = ? AND IdVenda = ?");
