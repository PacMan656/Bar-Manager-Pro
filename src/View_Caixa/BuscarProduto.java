...
import View.CustomDocument;
import gerenciador.Gestao;
...
public class BuscarProduto extends javax.swing.JFrame {
    ...
    public void fechar(){
    dispose();
		Caixa.TCodigo.requestFocusInWindow();
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
       if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
        ...
        Caixa.TCodigo.setText((String) jTable1.getModel().getValueAt(  jTable1.getSelectedRow() ,0));
        Caixa.TCodigo.requestFocusInWindow();
       }
