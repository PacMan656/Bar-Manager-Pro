...
public final class Caixa extends javax.swing.JFrame {
        ...
        new Thread() {
            ...
            public void run() {
                if (config == null) {
                    ...
                    config = new ConfiguraçõesCaixa(Caixa.this, caixa);
                    config.setVisible(true);

                } else {
                    config.setVisible(true);
                    config.setState(Caixa.NORMAL);
    ...
    public static void iniciaConfigurações() throws NfeException, CertificadoException, IOException {
        ...
        /*ConfiguracoesIniciaisNfe.iniciaConfiguracoes(Estados.BA , 
    ...
    public void BotãoPagamento() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                if (envia == null) {
                    envia = new OpPagamento(Caixa.this);
                    envia.setVisible(true);
                    envia.Total(TotalCompra, fluxo, add);

                } else {
                    envia.setVisible(true);
                    envia.setState(Caixa.NORMAL);
                    envia.Total(TotalCompra, fluxo, add);
    ...
    public void CPFnaNota() {
        Info.setText("Finalizando Venda...");
        if (enviaCPF == null) {
            enviaCPF = new CPFnaNota(Caixa.this);
            enviaCPF.setVisible(true);
        } else {
            enviaCPF.setVisible(true);
            enviaCPF.setState(Caixa.NORMAL);
        }
    }
    ...
    public void Adcionais() {
        ...
        TCodigo.setText("");
        if (enviaAdd == null) {
            enviaAdd = new OutrosVa(Caixa.this);
    ...
    public boolean interntet() {
        ...
        try {
            ...
            Caixa.Info.setText("<html>Erro ao conectar à internet:\n" + ex.getMessage() + "\nIniciando Módulo de Contigência</html>");
            return false;
        } catch (IOException ex) {
            Caixa.Info.setText("<html>Erro ao conectar à internet:\n" + ex.getMessage() + "\nIniciando Módulo de Contigência</html>");
            return false;
        ...
        new Thread() {
            ...
            public void run() {
                ...
                if (contigencia == true) {
                    ...
                    Caixa.Info.setText("<html>Emitindo Nota Fiscal \n Eletrônica Em Contigencia\n...Aguarde</html>");
                } else {
    ...
    public static void Tramite(int i) {
        ...
        if (i == 1) {
            Caixa.Info.setText("<html>Aguardando Retorno SEFAZ\n ...AGUARDE!!</html>");
        }
        if (i == 2) {
            Caixa.Info.setText("<html>Salvando Nota\n ...Aguarde</html>");
        }
        if (i == 3) {
            Caixa.Info.setText("<html>Imprimindo Nota\n ...Aguarde</html>");
        }
    }
    ...
    private void initComponents() {
        ...
        JTotal.setBackground(new java.awt.Color(51, 204, 255));
    ...
    private void TCodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TCodigoKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            Info.setText("Finalizando Compra...");
            TCodigo.setText("");
            BotãoPagamento();
        }
        if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) {
            Info.setText("Fechando Caixa...");
            TCodigo.setText("");
            FecharCaixa();
        }
        ...
        if (evt.getKeyCode() == KeyEvent.VK_A) {
            Info.setText("Obtendo Adicionais...");
            Adcionais();
        }
