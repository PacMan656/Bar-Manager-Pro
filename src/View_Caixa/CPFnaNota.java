 ...
 * @author Marcos
 */
public class CPFnaNota extends javax.swing.JFrame {

    private JFrame parent;
    
    public CPFnaNota(JFrame a) {
        this.parent = a;
        
        initComponents();
        Caixa.TCodigo.setText("");
   ...
   this.getRootPane().getActionMap().put("Fechar", new AbstractAction(){
    ...
    DDConsumidor consumidor = new DDConsumidor();
       ...
       consumidor.setCPF(jTextField1.getText()); 
       consumidor.setNome(jTextField4.getText()); 
       consumidor.setEndreço(jTextField3.getText());
    
       Caixa frame = (Caixa)parent;
                        frame.setVisible(true);
                        frame.pegaConsumidor(consumidor);
       dispose();
