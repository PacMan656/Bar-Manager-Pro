...
public class Gestao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Bestatistica.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bfinanceiro.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bfornecedores.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bentregas.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bestoque.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Brh.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bsegurança.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Becommerce.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bpromoções.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bimpostos.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bsuporte.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bimpressora.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bsuporte1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        Bsuporte2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jLabel1.setText("Bar Manager Pro 1.0");
    ...
    private void BimpressoraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BimpressoraActionPerformed
        ...
        jDesktopPane1.add(i);
        ((BasicInternalFrameUI) i.getUI()).setNorthPane(null); //retirar o painel superior
        i.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        try {
            i.setMaximum(true);
        } catch (PropertyVetoException ex) {
            Logger.getLogger(Gestao.class.getName()).log(Level.SEVERE, null, ex);
