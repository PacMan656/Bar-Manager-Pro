...
public class Server extends javax.swing.JFrame {
    ...
    public void IniciaServidor(){
        ...
        try {
            System.setProperty("derby.drda.startNetworkServer", "-h 0.0.0.0");
       ...
       jTextField1.setText("Iniciado");
    
    }
    public static void DesligaServidor(){
        try {
            server.shutdown();
        } catch (Exception ex) {
            Logger.getLogger(Server.class.getName()).log(Level.SEVERE, null, ex);
        }
        jTextField1.setText("Desligado");
       jTextArea2.setText("");
    }
    public void semnome(){
        ...
        try {
           // jTextArea2.append("\n"+server.getMaxThreads());
            //System.out.println("MaxThreads:"+server.getMaxThreads());
            jTextArea2.append(""+server.getRuntimeInfo());
            //System.out.println("RunTimeInfo:"+server.getRuntimeInfo());
           // jTextArea2.append("\n"+server.getTimeSlice());
            //System.out.println("TimeSlice:"+server.getTimeSlice());
            jTextArea2.append("\n"+"---------Propriedades Seridor");
            jTextArea2.append("\n"+server.getCurrentProperties());
            //System.out.println("CurrentProperties:"+server.getCurrentProperties());
            jTextArea2.append("\n\n"+server.getSysinfo());
            //System.out.println("Sysinfo:"+server.getSysinfo());
        } catch (Exception ex) {
            Logger.getLogger(Server.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gerenciador/Imagens/add-button-with-plus-symbol-in-a-black-circle.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gerenciador/Imagens/icon.png"))); // NOI18N
        jButton2.setText("Desligar Servidor");
        ...
        jPasswordField1.setText("1898456545454545454");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPasswordField1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)))
            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jLabel7.setForeground(new java.awt.Color(150, 0, 20));
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gerenciador/Imagens/actualize-arrows-couple-in-circle.png"))); // NOI18N
