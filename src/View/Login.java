...
public class Login extends javax.swing.JFrame {
   ...
   this.getRootPane().getActionMap().put("Dinheiro", new AbstractAction(){
    ...
    private void initComponents() {
        ...
        BAcessar1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        BAcessar.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        BAcessar2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        BAcessar3.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        BAcessar4.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        BAcessar5.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void BEsqueciActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BEsqueciActionPerformed
        CriacaoUser User = new CriacaoUser();
...
// Se o usuário não foi encontrado, pergunte se ele deseja criar uma nova conta
        if (!usuarioEncontrado) {
            int opcao = JOptionPane.showConfirmDialog(this, "Usuário não encontrado. Deseja criar uma nova conta?", "Novo Cadastro", JOptionPane.YES_NO_OPTION);
            if (opcao == JOptionPane.YES_OPTION) {
                // Abra a tela de criação de usuário
                CriacaoUser telaCriacao = new CriacaoUser();
